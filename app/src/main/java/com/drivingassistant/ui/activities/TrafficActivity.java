...
import com.drivingassistant.ui.activities.JSONParser;
...
public class TrafficActivity extends FragmentActivity implements OnMapReadyCallback {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if (location != null || !location.equals("")) {
                    Geocoder geocoder = new Geocoder(TrafficActivity.this);
    ...
    private void getCurrentLocation() {
        ...
        if (ActivityCompat.checkSelfPermission(this,
            ...
            ActivityCompat.requestPermissions(TrafficActivity.this,
